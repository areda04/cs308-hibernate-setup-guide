...
> **Note:** You must create a new user after installing Oracle Database via `SQL*Plus`. follow this GitHub Repository ![for Linux (Step 5/6/7)](https://github.com/areda04/cs307-oracle-sql-setup-guide/blob/main/Guides/LINUX_README.md) or ![for Windows (Step 3/4/5)](https://github.com/areda04/cs307-oracle-sql-setup-guide/blob/main/Guides/WINDOWS_README.md).
...
> **Note:** If you have forgotten your password, you must create a new user via `SQL*Plus`. ![for Linux (Step 5/6/7)](https://github.com/areda04/cs307-oracle-sql-setup-guide/blob/main/Guides/LINUX_README.md) or ![for Windows (Step 3/4/5)](https://github.com/areda04/cs307-oracle-sql-setup-guide/blob/main/Guides/WINDOWS_README.md).
...
> **Note:** If the Script Output prints errors on your screen, you may need to edit your user's credentials via `SQL*Plus`. follow this GitHub Repository ![for Linux (Step 5/6/7)](https://github.com/areda04/cs307-oracle-sql-setup-guide/blob/main/Guides/LINUX_README.md) or ![for Windows (Step 3/4/5)](https://github.com/areda04/cs307-oracle-sql-setup-guide/blob/main/Guides/WINDOWS_README.md).
